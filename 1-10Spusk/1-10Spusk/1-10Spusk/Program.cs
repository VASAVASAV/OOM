...
namespace _1_8Huk
{
    class MyProg : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label7.Text = "Введіть початкове обмеження λ";
            // 
            // textBox6
            // 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Num++;
                TempMaxLam = LastLambda;
                TempLambda = a.NextDouble() * (TempMaxLam);
                ////
                for (i = 1; i <= NumberOfDim; i++)
                {
                    pars.AddVariable("x" + i, CurPoint[i-1] - TempLambda*Grad[i-1]);
                }
